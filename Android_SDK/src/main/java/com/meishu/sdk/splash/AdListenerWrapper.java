...
public class AdListenerWrapper implements SplashAdListener {
    private DelegateChain delegateChain;
    private SplashAdListener apiAdListener;

    public AdListenerWrapper(@NonNull DelegateChain delegateChain, @Nullable SplashAdListener apiAdListener) {
