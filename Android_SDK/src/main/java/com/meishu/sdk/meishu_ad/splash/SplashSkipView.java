...
public class SplashSkipView extends View {
    ...
    public SplashSkipView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void start() {
        ...
        if (mHandler != null && !mHandler.hasMessages(SPACE_TIME_ANGLE)) {
    ...
    private void setLifecycleListener() {
        ...
        if (activity != null) {
            if (activity instanceof FragmentActivity) {
                LifecycleFragment_V4 fragment = LifecycleFragment_V4.createLifecycleListenerFragment((FragmentActivity) activity);
                fragment.setLifecycleListener(mLifeListener);
            } else {
                LifecycleFragment fragment = LifecycleFragment.createLifecycleListenerFragment(activity);
                fragment.setLifecycleListener(mLifeListener);
            }
        } else {
            Log.e(TAG, "setLifecycleListener: ", new Exception("SkipView的Context非Activity"));
        }
    }
    ...
    private LifecycleListener mLifeListener = new LifecycleListener() {
