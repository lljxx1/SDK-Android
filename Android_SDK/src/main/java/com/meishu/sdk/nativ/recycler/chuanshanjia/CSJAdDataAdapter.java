...
public class CSJAdDataAdapter implements AdData {
    ...
    public CSJAdDataAdapter(@NonNull CSJTTAdNativeWrapper adNativeWrapper, @NonNull TTFeedAd ttFeedAd) {
    ...
    @Override
    public void bindAdToView(Activity activity, ViewGroup container, List<View> creativeClickableViews, AdInteractionListener adInteractionListener) {
