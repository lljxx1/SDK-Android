...
public class CSJNativeAdDataAdapter implements NativeAdData {

    private TTNativeAd ttNativeAd;
    private CSJNativeAdListener adListener;

    public CSJNativeAdDataAdapter(@NonNull TTNativeAd ttNativeAd, CSJNativeAdListener adListener) {
    ...
    public void bindAdToView(Activity activity, ViewGroup adContainer, List<View> clickableViews, AdInteractionListener adInteractionListener) {
        ttNativeAd.registerViewForInteraction(adContainer, clickableViews, null, new CSJAdInteractionListener(this, adInteractionListener));
    }
