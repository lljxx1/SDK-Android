...
public class GDTNativeAdDataAdapter implements NativeAdData {

    private NativeUnifiedADData gdtNativeADData;
    private GDTNativeAdListenerImpl adListener;

    public GDTNativeAdDataAdapter(@NonNull NativeUnifiedADData gdtNativeADData, GDTNativeAdListenerImpl adListener) {
    ...
    @Override
    public void bindAdToView(Activity activity, ViewGroup adContainer, List<View> clickableViews, AdInteractionListener nativeAdEventListener) {
