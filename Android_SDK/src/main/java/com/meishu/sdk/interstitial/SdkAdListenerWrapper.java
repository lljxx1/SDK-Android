...
public class SdkAdListenerWrapper implements InterstitialAdListener {
    private DelegateChain delegateChain;
    private InterstitialAdListener apiAdListener;

    public SdkAdListenerWrapper(@NonNull DelegateChain delegateChain, @Nullable InterstitialAdListener apiAdListener) {
