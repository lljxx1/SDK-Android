...
public class NativeRecyclerListV3Activity extends AppCompatActivity implements NativeAdListener {
        ...
        recyclerView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if (!mIsLoading && newState == SCROLL_STATE_IDLE && !recyclerView.canScrollVertically(1)) {
                    mIsLoading = true;
                    NativeRecyclerListV3Activity.this.nativeAdLoader.loadAd();
                }
    ...
    class CustomAdapter extends RecyclerView.Adapter<CustomHolder> {
        ...
        private void initItemView(int position, final CustomHolder holder) {
            ...
            ad.bindAdToView(NativeRecyclerListV3Activity.this, holder.container,
