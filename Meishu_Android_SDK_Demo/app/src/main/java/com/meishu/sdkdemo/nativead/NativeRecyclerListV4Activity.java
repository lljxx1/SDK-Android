...
public class NativeRecyclerListV4Activity extends AppCompatActivity implements NativeAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        nativeAdLoader = new NativeAdLoader(this, "1003912", this);//信息流
        ...
        recyclerView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if (!mIsLoading && newState == SCROLL_STATE_IDLE && !recyclerView.canScrollVertically(1)) {
                    mIsLoading = true;
                    NativeRecyclerListV4Activity.this.nativeAdLoader.loadAd();
                }
    ...
    class CustomAdapter extends RecyclerView.Adapter<CustomHolder> {
        ...
        private void initItemView(int position, final CustomHolder holder) {
            ...
            clickableViews.add(holder.topAdInfoContainer);
            // 视频广告
            ...
            ad.bindAdToView(NativeRecyclerListV4Activity.this, holder.container,
    ...
    class CustomHolder extends RecyclerView.ViewHolder {
        ...
        public RelativeLayout topAdInfoContainer;
        public RelativeLayout bottomAdInfoContainer;
